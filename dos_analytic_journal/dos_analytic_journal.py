...
class account_anlytic_line_inherit(models.Model):
    ...
    task_name_hour = fields.Many2one('project.task','Task Name')
    task_name_hourly = fields.Many2one('project.task','Task Name Hourly')
    ...
    def do_update_ent(self):
        ...
        for i in analytic_line_rec:
            ...
            elif i.journal_id.code == "SALMAT":
                #print i.task_mat_id.hours
                i.total_no_of_hours = i.task_mat_id.hours
                i.hours_materials = i.task_mat_id.hours
	    else:
		print "Nothing"
