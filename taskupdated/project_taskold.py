...
class project_description(osv.Model):
    ...
    'hourly_check' : fields.boolean("For Hourly Work", help="If you check this field in task hourly menu will be shown. This field deside wheather you want to select task type hourly based or fixed based unchecking this field will show task as fixed not hourly."),
    }
